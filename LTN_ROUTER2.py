...
if __name__ == "__main__":
    while(1):
        try:
            banner=pyfiglet.figlet_format("ILT ROUTER", font="slant")
            print(banner)
            print("\t Script by SOHEIL_ROUTER")
            print("\n")
            print(" Router will not responsible for the loss you have done or made ")
            ...
            print("3.Brtueforce(coming soon)           4.Port Scanner")
